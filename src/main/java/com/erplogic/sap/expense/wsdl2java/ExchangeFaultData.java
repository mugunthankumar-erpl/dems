...
@XmlType(name = "ExchangeFaultData", namespace = "http://sap.com/xi/AP/Common/Global", propOrder = {"faultText",
    "faultUrl", "faultDetail"})
public class ExchangeFaultData {

    @XmlElement(required = true)
    private String faultText;
    private String faultUrl;
    private List<ExchangeLogData> faultDetail;
     ...
     *
     */
    public void setFaultText(final String value) {
     ...
     *
     */
    public void setFaultUrl(final String value) {
        this.faultUrl = value;
    }
