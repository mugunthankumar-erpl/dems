...
/**
 * <p>
 * Java class for MaintenanceAttachmentFolderDocumentProperty complex type.
 *
 * <p>
...
@XmlType(name = "MaintenanceAttachmentFolderDocumentProperty", namespace = "http://sap.com/xi/DocumentServices/Global", propOrder = {
    "technicalID", "name", "dataTypeFormatCode", "visibleIndicator", "changeAllowedIndicator", "multipleValueIndicator",
    "namespaceURI", "description", "propertyValue"})
public class MaintenanceAttachmentFolderDocumentProperty {
    ...
    private List<MaintenanceAttachmentFolderDocumentPropertyPropertyValue> propertyValue;
    @XmlAttribute(name = "PropertyValueListCompleteTransmissionIndicator")
    private Boolean propertyValueListCompleteTransmissionIndicator;
    ...
    /**
     * Gets the value of the propertyValueListCompleteTransmissionIndicator
     * property.
     *
     * @return possible object is {@link Boolean }
     *
    ...
    /**
     * Sets the value of the propertyValueListCompleteTransmissionIndicator
     * property.
     *
     * @param value allowed object is {@link Boolean }
     *
     */
    public void setPropertyValueListCompleteTransmissionIndicator(final Boolean value) {
