...
/**
 * <p>
 * Java class for MaintenanceAttachmentFolder complex type.
 *
 * <p>
...
public class MaintenanceAttachmentFolder {
    ...
    private List<MaintenanceAttachmentFolderDocument> document;
    @XmlAttribute(name = "DocumentListCompleteTransmissionIndicator")
    private Boolean documentListCompleteTransmissionIndicator;
     ...
     *
     */
    public void setDocumentListCompleteTransmissionIndicator(final Boolean value) {
