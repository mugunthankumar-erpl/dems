...
/**
 * <p>
 * Java class for ExpenseReportUpdateRequest complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="ExpenseReportUpdateRequest"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="EmployeeBankDetailsKey" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportUpdateRequestEmployeeBankDetailsKey" minOccurs="0"/&gt;
 ...
 *         &lt;element name="Advance" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportUpdateRequestAdvance" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Reimbursement" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportUpdateRequestReimbursement" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="TextCollection" type="{http://sap.com/xi/DocumentServices/Global}MaintenanceTextCollection" minOccurs="0"/&gt;
 *         &lt;element name="Receipt" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportUpdateRequestReceipt" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="Mileage" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportUpdateRequestMileage" maxOccurs="unbounded" minOccurs="0"/&gt;
 *         &lt;element name="ItinerarySegment" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportUpdateRequestItinerarySegment" maxOccurs="unbounded" minOccurs="0"/&gt;
 ...
 *       &lt;/sequence&gt;
 *       &lt;attribute name="AdvanceListCompleteTransmissionIndicator" type="{http://sap.com/xi/AP/Common/GDT}Indicator" /&gt;
 *       &lt;attribute name="ReceiptListCompleteTransmissionIndicator" type="{http://sap.com/xi/AP/Common/GDT}Indicator" /&gt;
 *       &lt;attribute name="MileageListCompleteTransmissionIndicator" type="{http://sap.com/xi/AP/Common/GDT}Indicator" /&gt;
 *       &lt;attribute name="ItinerarySegmentListCompleteTransmissionIndicator" type="{http://sap.com/xi/AP/Common/GDT}Indicator" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
...
@XmlType(name = "ExpenseReportUpdateRequest", propOrder = {"uuid", "id", "employeeID", "typeCode", "period",
...
public class ExpenseReportUpdateRequest {
    ...
    private ExpenseReportUpdateRequestEmployeeBankDetailsKey employeeBankDetailsKey;
    ...
    private List<ExpenseReportUpdateRequestAdvance> advance;
    @XmlElement(name = "Reimbursement")
    private List<ExpenseReportUpdateRequestReimbursement> reimbursement;
    @XmlElement(name = "TextCollection")
    private MaintenanceTextCollection textCollection;
    @XmlElement(name = "Receipt")
    private List<ExpenseReportUpdateRequestReceipt> receipt;
    @XmlElement(name = "Mileage")
    private List<ExpenseReportUpdateRequestMileage> mileage;
    @XmlElement(name = "ItinerarySegment")
    private List<ExpenseReportUpdateRequestItinerarySegment> itinerarySegment;
    ...
    @XmlAttribute(name = "AdvanceListCompleteTransmissionIndicator")
    private Boolean advanceListCompleteTransmissionIndicator;
    @XmlAttribute(name = "ReceiptListCompleteTransmissionIndicator")
    private Boolean receiptListCompleteTransmissionIndicator;
    @XmlAttribute(name = "MileageListCompleteTransmissionIndicator")
    private Boolean mileageListCompleteTransmissionIndicator;
    @XmlAttribute(name = "ItinerarySegmentListCompleteTransmissionIndicator")
    private Boolean itinerarySegmentListCompleteTransmissionIndicator;
     ...
     *         {@link ExpenseReportUpdateRequestEmployeeBankDetailsKey }
     *
     */
    public ExpenseReportUpdateRequestEmployeeBankDetailsKey getEmployeeBankDetailsKey() {
     ...
     *
     */
    public void setEmployeeBankDetailsKey(final ExpenseReportUpdateRequestEmployeeBankDetailsKey value) {
     ...
     * {@link ExpenseReportUpdateRequestAdvance }
     *
     *
     */
    public List<ExpenseReportUpdateRequestAdvance> getAdvance() {
        if (advance == null) {
            advance = new ArrayList<ExpenseReportUpdateRequestAdvance>();
        }
        return this.advance;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExpenseReportUpdateRequestReimbursement }
     *
     *
     */
    public List<ExpenseReportUpdateRequestReimbursement> getReimbursement() {
        if (reimbursement == null) {
            reimbursement = new ArrayList<ExpenseReportUpdateRequestReimbursement>();
        }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExpenseReportUpdateRequestReceipt }
     *
     *
     */
    public List<ExpenseReportUpdateRequestReceipt> getReceipt() {
        if (receipt == null) {
            receipt = new ArrayList<ExpenseReportUpdateRequestReceipt>();
        }
        return this.receipt;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExpenseReportUpdateRequestMileage }
     *
     *
     */
    public List<ExpenseReportUpdateRequestMileage> getMileage() {
        if (mileage == null) {
            mileage = new ArrayList<ExpenseReportUpdateRequestMileage>();
        }
        return this.mileage;
    }
     ...
     * <p>
     * Objects of the following type(s) are allowed in the list
     * {@link ExpenseReportUpdateRequestItinerarySegment }
     *
     *
     */
    public List<ExpenseReportUpdateRequestItinerarySegment> getItinerarySegment() {
        if (itinerarySegment == null) {
            itinerarySegment = new ArrayList<ExpenseReportUpdateRequestItinerarySegment>();
        }
    ...
    /**
     * Gets the value of the advanceListCompleteTransmissionIndicator property.
     *
     * @return possible object is {@link Boolean }
     *
     */
    public Boolean isAdvanceListCompleteTransmissionIndicator() {
        return advanceListCompleteTransmissionIndicator;
    }

    /**
     * Sets the value of the advanceListCompleteTransmissionIndicator property.
     *
     * @param value allowed object is {@link Boolean }
     *
     */
    public void setAdvanceListCompleteTransmissionIndicator(final Boolean value) {
        this.advanceListCompleteTransmissionIndicator = value;
    }

    /**
     * Gets the value of the receiptListCompleteTransmissionIndicator property.
     *
     * @return possible object is {@link Boolean }
     *
     */
    public Boolean isReceiptListCompleteTransmissionIndicator() {
        return receiptListCompleteTransmissionIndicator;
    }

    /**
     * Sets the value of the receiptListCompleteTransmissionIndicator property.
     *
     * @param value allowed object is {@link Boolean }
     *
     */
    public void setReceiptListCompleteTransmissionIndicator(final Boolean value) {
        this.receiptListCompleteTransmissionIndicator = value;
    }

    /**
     * Gets the value of the mileageListCompleteTransmissionIndicator property.
     *
     * @return possible object is {@link Boolean }
     *
     */
    public Boolean isMileageListCompleteTransmissionIndicator() {
        return mileageListCompleteTransmissionIndicator;
    }

    /**
     * Sets the value of the mileageListCompleteTransmissionIndicator property.
     *
     * @param value allowed object is {@link Boolean }
     *
     */
    public void setMileageListCompleteTransmissionIndicator(final Boolean value) {
        this.mileageListCompleteTransmissionIndicator = value;
    }

    /**
     * Gets the value of the itinerarySegmentListCompleteTransmissionIndicator
     * property.
     *
     * @return possible object is {@link Boolean }
     *
     */
    public Boolean isItinerarySegmentListCompleteTransmissionIndicator() {
        return itinerarySegmentListCompleteTransmissionIndicator;
    }

    /**
     * Sets the value of the itinerarySegmentListCompleteTransmissionIndicator
     * property.
     *
     * @param value allowed object is {@link Boolean }
     *
     */
    public void setItinerarySegmentListCompleteTransmissionIndicator(final Boolean value) {
        this.itinerarySegmentListCompleteTransmissionIndicator = value;
    }
