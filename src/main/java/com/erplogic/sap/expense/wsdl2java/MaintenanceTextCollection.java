...
/**
 * <p>
 * Java class for MaintenanceTextCollection complex type.
 *
 * <p>
...
public class MaintenanceTextCollection {
    ...
    private List<MaintenanceTextCollectionText> text;
    @XmlAttribute(name = "TextListCompleteTransmissionIndicator")
    private Boolean textListCompleteTransmissionIndicator;
     ...
     *
     */
    public void setTextListCompleteTransmissionIndicator(final Boolean value) {
