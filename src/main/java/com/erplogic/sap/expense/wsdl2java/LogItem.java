...
/**
 * <p>
 * Java class for LogItem complex type.
 *
 * <p>
...
@XmlType(name = "LogItem", namespace = "http://sap.com/xi/AP/Common/GDT", propOrder = {"typeID", "categoryCode",
    "severityCode", "referenceObjectNodeSenderTechnicalID", "referenceMessageElementName", "note", "noteTemplateText",
    "logItemNotePlaceholderSubstitutionList", "webURI"})
public class LogItem {
    ...
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    private String referenceObjectNodeSenderTechnicalID;
    @XmlElement(name = "ReferenceMessageElementName")
    private String referenceMessageElementName;
    ...
    private LogItemNotePlaceholderSubstitutionList logItemNotePlaceholderSubstitutionList;
     ...
     *
     * @return possible object is {@link LogItemCategoryCode }
     *
     */
     ...
     *
     * @param value allowed object is {@link LogItemCategoryCode }
     *
     */
    public void setCategoryCode(final LogItemCategoryCode value) {
     ...
     *
     */
    public void setSeverityCode(final String value) {
     ...
     *
     */
    public void setReferenceObjectNodeSenderTechnicalID(final String value) {
     ...
     *
     */
    public void setReferenceMessageElementName(final String value) {
     ...
     *
     */
    public void setNoteTemplateText(final String value) {
     ...
     *
     * @return possible object is {@link LogItemNotePlaceholderSubstitutionList }
     *
     */
     ...
     *
     * @param value allowed object is {@link LogItemNotePlaceholderSubstitutionList
     *              }
     *
     */
    public void setLogItemNotePlaceholderSubstitutionList(final LogItemNotePlaceholderSubstitutionList value) {
