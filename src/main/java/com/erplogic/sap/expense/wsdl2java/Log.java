...
@XmlType(name = "Log", namespace = "http://sap.com/xi/AP/Common/GDT", propOrder = {
    "businessDocumentProcessingResultCode", "maximumLogItemSeverityCode", "item"})
public class Log {
    ...
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    @XmlSchemaType(name = "token")
    private String maximumLogItemSeverityCode;
    @XmlElement(name = "Item")
    private List<LogItem> item;
     ...
     *
     */
    public void setBusinessDocumentProcessingResultCode(final String value) {
     ...
     *
     */
    public void setMaximumLogItemSeverityCode(final String value) {
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link LogItem }
     *
     *
     */
