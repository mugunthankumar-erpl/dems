...
/**
 * <p>
 * Java class for ExpenseReportReadByIDResponseAuditor complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="ExpenseReportReadByIDResponseAuditor"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Status" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportReadByIDResponseAuditorStatus" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ExpenseReportReadByIDResponseAuditor", propOrder = {"uuid", "internalID",
    "partialSystemAdministrativeData", "status"})
public class ExpenseReportReadByIDResponseAuditor {
    ...
    private ExpenseReportReadByIDResponseAuditorStatus status;
     ...
     *
     * @return possible object is {@link ExpenseReportReadByIDResponseAuditorStatus
     *         }
     *
     */
    public ExpenseReportReadByIDResponseAuditorStatus getStatus() {
        return status;
    }
     ...
     *              {@link ExpenseReportReadByIDResponseAuditorStatus }
     *
     */
    public void setStatus(final ExpenseReportReadByIDResponseAuditorStatus value) {
        this.status = value;
    }
