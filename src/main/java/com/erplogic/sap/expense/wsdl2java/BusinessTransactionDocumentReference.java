...
/**
 * <p>
 * Java class for BusinessTransactionDocumentReference complex type.
 *
 * <p>
...
@XmlType(name = "BusinessTransactionDocumentReference", namespace = "http://sap.com/xi/AP/Common/GDT", propOrder = {
    "id", "uuid", "typeCode", "itemID", "itemUUID", "itemTypeCode"})
public class BusinessTransactionDocumentReference {
    ...
    private BusinessTransactionDocumentTypeCode typeCode;
     ...
     *
     */
    public void setID(final BusinessTransactionDocumentID value) {
        this.id = value;
    }
     ...
     *
     * @return possible object is {@link BusinessTransactionDocumentTypeCode }
     *
     */
     ...
     *
     * @param value allowed object is {@link BusinessTransactionDocumentTypeCode }
     *
     */
    public void setTypeCode(final BusinessTransactionDocumentTypeCode value) {
        this.typeCode = value;
    }
     ...
     *
     */
    public void setItemUUID(final UUID value) {
        this.itemUUID = value;
    }
