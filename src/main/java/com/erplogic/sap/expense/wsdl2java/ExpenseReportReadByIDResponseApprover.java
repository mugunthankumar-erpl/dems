...
/**
 * <p>
 * Java class for ExpenseReportReadByIDResponseApprover complex type.
 *
 * <p>
 ...
 *
 * <pre>
 * &lt;complexType name="ExpenseReportReadByIDResponseApprover"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="Status" type="{http://483888-one-off.sap.com/YGCBELCOY_}ExpenseReportReadByIDResponseApproverStatus" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlType(name = "ExpenseReportReadByIDResponseApprover", propOrder = {"uuid", "internalID",
    "partialSystemAdministrativeData", "status"})
public class ExpenseReportReadByIDResponseApprover {
    ...
    private ExpenseReportReadByIDResponseApproverStatus status;
     ...
     *
     * @return possible object is {@link ExpenseReportReadByIDResponseApproverStatus
     *         }
     *
     */
    public ExpenseReportReadByIDResponseApproverStatus getStatus() {
        return status;
    }
     ...
     *              {@link ExpenseReportReadByIDResponseApproverStatus }
     *
     */
    public void setStatus(final ExpenseReportReadByIDResponseApproverStatus value) {
        this.status = value;
    }
